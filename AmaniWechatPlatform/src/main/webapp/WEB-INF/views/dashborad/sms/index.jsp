				...
				<td id="leftSonNavBox" valign="top" width="150" height="100%">
					<div class="leftSonNavBox">
						...
						<div class="maxNavBoxs">
							<a href="javascript:;" class="current maxA" target="targetBoxs"><i></i><span></span>消息管理</a>
							<ul class="sonNavBox" style="display: block;">
								<a href="${ROOT_PATH }Dashboard/Sms/Sms/index" class="minA current"
									target="targetBoxs"><i></i><span></span>消息列表</a>
							</ul>
						</div>
					</div>
				</td>
