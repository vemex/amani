				...
				<td id="leftSonNavBox" valign="top" width="150" height="100%">
					<div class="leftSonNavBox">
						...
						<div class="maxNavBoxs">
							<a href="javascript:;" class="current maxA" target="targetBoxs"><i></i><span></span>欢迎语设置</a>
						...
						<div class="maxNavBoxs">
							<a href="javascript:;" class="current maxA" target="targetBoxs"><i></i><span></span>自动回复设置</a>
							<ul class="sonNavBox" style="display: block;">
								<a href="${ROOT_PATH }Dashboard/WechatMsg/AutoReplyMsg/index"
									class="minA current" target="targetBoxs"><i></i><span></span>信息管理</a>
							</ul>
						</div>
						<div class="maxNavBoxs">
							<a href="javascript:;" class="current maxA" target="targetBoxs"><i></i><span></span>关键词设置</a>
							<ul class="sonNavBox" style="display: block;">
								<a href="${ROOT_PATH }Dashboard/WechatMsg/KeyWordMsg/index"
									class="minA" target="targetBoxs"><i></i><span></span>关键词管理</a>
								<a href="${ROOT_PATH }Dashboard/WechatMsg/KeyWordMsg/add"
									class="minA" target="targetBoxs"><i></i><span></span>添加关键词</a>
							</ul>
						</div>
					</div>
				</td>
