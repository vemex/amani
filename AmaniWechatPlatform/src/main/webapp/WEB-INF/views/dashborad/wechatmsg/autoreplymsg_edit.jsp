...
<body>
	<div class="manageBoxs">
		...
		<div class="itemCateNav">
			<div class="cateChoose">
				<a href="${ROOT_PATH }Dashboard/WechatMsg/WelcomeMsg/index"><span
					id="txt">信息管理</span><span id="bgr"></span></a> 
				<a href="${ROOT_PATH }Dashboard/WechatMsg/WelcomeMsg/add"><span
					id="txt">添加信息</span><span id="bgr"></span></a>
				 <a href="javascript:;"
					class="on"><span id="txt">编辑信息</span><span id="bgr"></span></a>
			</div>
		</div>
					...
					<tbody>
						<tr class="tr1 vt">
							...
							<td width="89%" class="td2"><input id="title"
								class="lk-input" name="title" value="欢迎语" style="width: 500px;"></td>
						</tr>
						<tr class="tr1 vt">
							<td width="11%" align="right" class="td1"><span class="red">*</span>
								信息类型：</td>
						...
						<tr class="tr1 vt" id="text">
							...
							<td width="89%" class="td2"><textarea id="content"
									...
									style="width: 60%; height: 100px;">您好，欢迎关注我们！</textarea></td>
						</tr>
						...
						<tr class="tr1 vt">
							<td width="11%" align="right" class="td1"><span class="red">*</span>
								是否启用：</td>
							<td width="89%" class="td2"><label><input
									type="radio" id="isopen1" value="0" name="isopen">关闭</label> <label><input
									type="radio" id="isopen2" value="1" checked="" name="isopen">开启</label>
							</td>
						</tr>
						<tr class="tr1 vt">
							...
							<td width="89%" class="td2"><input type="hidden"
								...
								type="hidden" name="id" id="id" value="1"> <input
		...
		<script type="text/javascript"
			src="${ROOT_PATH }content/scripts/admin/reply.js"></script>
	</div>
