...
public class Dnointernalcardinfo  implements java.io.Serializable {
    ...
    // Fields    
     ...
     private String ineritemno;//项目编号
     private BigDecimal entrycount;//登记次数
     private BigDecimal usecount;//使用次数
     private BigDecimal lastcount;//剩余次数
     private BigDecimal entryamt;//登记余额
     private BigDecimal useamt;//使用余额
     private BigDecimal lastamt;//剩余余额
     private BigDecimal costcount;//消费单号
     private BigDecimal costamt;//备注
